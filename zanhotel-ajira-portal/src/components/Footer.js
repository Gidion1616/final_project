    ...
    <footer style={styles.footer}>
      <div style={styles.container}>
        <div style={styles.section}>
          ...
          <p style={styles.text}>
            A digital platform that enables youth to apply for jobs in various hotels across Tanzania easily.
          </p>
        </div>
      ...
      <div style={styles.bottomBar}>
        <p style={styles.copyright}>
          &copy; {new Date().getFullYear()} ZanHotel-Ajira Portal. All rights reserved.
        </p>
      </div>
    </footer>
  );
...
const styles = {
  ...
  horizontalLinks: { display: 'flex', flexWrap: 'wrap', gap: '25px', marginTop: '2px' },
  horizontalLink: { color: "#ccc", textDecoration: "none", fontSize: "13px", transition: 'all 0.2s ease', fontWeight: '500' },
  contactItem: { display: 'flex', alignItems: 'center', marginBottom: '2px' },
  ...
  socialIcons: { display: 'flex', gap: '30px' },
  socialIcon: { width: '23px', height: '23px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.3s ease' },
  bottomBar: { textAlign: "center", height: "15px", padding: "4px 0", fontSize: "13px", backgroundColor: "#05193f" },
